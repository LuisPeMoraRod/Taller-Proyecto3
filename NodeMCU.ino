...
void procesar(String input, String * output){
  ...
  while(delComa>0){
    ...
    */
    ...
    else if (comando=="Acel"){
      *output = getAcceleration();
      }
    else if (comando=="nada"){
      *output = "";
      }
    else{
...
String getSaved(){
  String result;
  if (buenestado==true){result = "Bueno";}
  else{result="Malo";}
  return result;
}
String getLight(){
...
String getTime(){
  return String(tiempogiro*pow(10,-3));
  }
String getAcceleration(){
  return String(aceleracion);
  }
...
String especial(){
  ...
  direct=true;
  inicio=millis();
  String result = "Mov. especial: cuadrado";
  return result;
}
String diagnostic(){
  diagnostico=true;luces=true;
  inicio=millis();
  String result = "Realizando diagnostico";
  return result; 
  }
