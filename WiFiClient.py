...
class NodeMCU(Thread):
    ...
    que debe tomarse en consideración, variables como busy o el len(log) permiten conocer si se recibió un nuevo mensaje. 
    """
    #           ___________________________           
    ...
    def __init__(self, ip = '172.20.10.12', port = 7070): #'192.168.99.200'
    ...
    def run(self):
        """
        Esta función se llama al ejecutar NodeMCU.start()
    ...
    def readById(self, id):
        ...
        """
        response = ""
        if(isinstance(id,str) and ":" in id and "-"):
           index = id.split(":")
           i = index[0]
           subi =index[1]
